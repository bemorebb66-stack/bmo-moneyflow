...
const SECTIONS = [
  ...
  {
    title: "BVT Replay 거래내역",
    body: "BVT Replay에서 선택한 거래내역 CSV·Excel 파일은 이용자의 브라우저 안에서만 읽고 계산합니다. 계좌번호·고객명 등 개인정보 열은 분석에서 제외하며, 원본 파일과 체결내역은 BVT 서버나 AI 서비스로 전송하거나 저장하지 않습니다. 페이지를 닫거나 새로고침하면 분석 화면에서 제거됩니다.",
  },
  {
    title: "제3자 서비스",
